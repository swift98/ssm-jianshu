...
public class WordDetect {
    public static String filePath = "./static/senseword/dictionary.txt";//敏感词库文件路径
    public static String directoryPath="E:\\Java\\jianshu_blog_v3\\src\\main\\java\\word_filter\\static\\senseword";
