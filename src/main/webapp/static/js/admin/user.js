...
function userDel(userid, pageStart) {
    ...
    $.ajax({
        url: APP_PATH + "/adminController/deleteUser.do",
        type: "post",
        dataType: "json",
        data:{"userid":userid},
        success: function (result) {
            if (result.resultCode == 200){
                $.ajax({
                    url: APP_PATH + "/adminController/getUser.do?pageStart="+pageStart,
                    type: "post",
                    dataType: "json",
                    success: function (data) {
                        ...
                        for (var i=0;i<listUsers.length;i++){
                            ...
                            if(listUser["photo"] == null){  //默认头像
                                listUser_userphoto =
                                    '<a href="'+APP_PATH+'/static/user/a9666fef-d613-4374-89ac-855a0158836d1517883884441.jpg" target="_brank">' +
                                    '<img src="'+APP_PATH+'/static/user/a9666fef-d613-4374-89ac-855a0158836d1517883884441.jpg" style="position: relative; width: 100%; height: 100%;">' +
                                    '</a>';
                            } else {
                                listUser_userphoto =
                                    '<a href="'+APP_PATH+'/static/user/'+listUser["userphoto"]+'" target="_brank">' +
                                    '<img src="'+APP_PATH+'/static/user/'+listUser["userphoto"]+'" style="position: relative; width: 100%; height: 100%;">' +
                                    '</a>';
                            }
